...
insert into Attractions values ('阿柑姨芋圓','新北市','餐廳','新北市瑞芳區豎崎路5號','02 2497 6505','山中清幽小鎮九份一直是台灣著名景點之一，當然觀光客也絡繹不絕拉，雖然人潮眾多，但還是忘不了九份的美“阿柑姨芋圓” 真是讓人忘不了的好滋味啊！！從以前學生時代來這玩時  就來吃過阿柑姨芋圓，小小的階梯上去非常隱秘吃過幾家九份的芋圓 ，還是阿柑姨最好吃！',null)
insert into Attractions values ('阿蘭草仔粿芋粿','新北市','餐廳','新北市瑞芳區基山街90號','02 2496 -7795','阿蘭草仔粿是一個有阿蘭草仔粿、平價、九份老街的休閒零食，網友認為值得推薦的有：草仔粿、芋粿、菜埔草仔粿、芋粿巧、菜蒲米草仔粿。',null)
